//
//  QSYKDetailPicutreViewController.m
//  qingsongyike
//
...
@interface QSYKDetailPicutreViewController ()
...
@implementation QSYKDetailPicutreViewController
...
- (UIButton *)saveBtn{
    if (_saveBtn == nil) {
        ...
        _saveBtn.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.3];
        CGRect frame = _saveBtn.frame;
        frame.size = CGSizeMake(45, 28);
        _saveBtn.frame = frame;
        _saveBtn.layer.borderWidth = 1.0 / [[UIScreen mainScreen] scale];
        _saveBtn.layer.borderColor = [[UIColor lightGrayColor] CGColor];
        _saveBtn.layer.cornerRadius = 2.f;
...
//            [self saveImageBtn];
//        }];
        [_saveBtn addTarget:self action:@selector(saveImageBtn) forControlEvents:UIControlEventTouchUpInside];
    }
    return _saveBtn;
}
