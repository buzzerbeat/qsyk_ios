...
@interface QSYKTopicPageViewController () <QSYKCellDelegate, QSYKInnerPageDelegate>
...
- (void)removeRedundantResource:(NSArray *)resources {
    ...
    // 发送去重日志
    NSString *urlStr = [NSString stringWithFormat:@"%@/logdomain/listCombine/t/%d/p/%d/a/%u", kLogBaseURL, RESOURCE_TYPE, _currentPage, resources.count - finalResources.count];
...
- (void)pushToInnerPageWithIndexPath:(NSIndexPath *)indexPath needScroll:(BOOL)needScorll {
    ...
    innerPage.needScrollToPost = YES;
